...
def get_config():
    ...
    config.env.map_name = 'cleanup_map'  # 'cleanup_small_sym'|'cleanup_10x10_sym'
    config.env.max_steps = 1000 # small: 50 | 10x10: 50
    config.env.n_agents = 5
    config.env.enable_penalty_beam = True
    ...
    config.env.cleanup_params.appleRespawnProbability = 0.05  # 10x10 0.3 | small 0.5
    ...
    config.lio.epsilon_div = 1e3  # small 1e2, 10x10 1e3
    ...
    config.main.dir_name = 'cleanup_n5_lio_05'
    config.main.exp_name = 'cleanup_n5_lio'
